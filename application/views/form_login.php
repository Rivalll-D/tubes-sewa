...
<section class="hero-wrap ftco-degree-bg" style="background-image: url('<?php echo base_url() ?>/assets/assets_shop/images/back-gg01.jpg');" data-stellar-background-ratio="0.5">
    <div class="container mt-5">
        <div class="row">
            <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                <div class="login-brand">
                    <img src="<?php echo base_url() ?>/assets/assets_shop/images/logo-01.png" alt="logo" width="100" class="shadow-light rounded-circle">
                </div>
